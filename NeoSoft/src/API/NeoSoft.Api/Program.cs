...
using NeoSoft.Api.Middleware;
using NeoSoft.Application;
using NeoSoft.Application.Contracts;
using NeoSoft.Infrastructure;
using NeoSoft.Persistence;
using NeoSoft.Identity;
using NeoSoft.Api.Services;
using NeoSoft.Api.Extensions;
using Microsoft.Extensions.Options;
using Swashbuckle.AspNetCore.SwaggerGen;
using NeoSoft.Api.SwaggerHelper;
